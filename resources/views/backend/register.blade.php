                ...
                <div class="card p-2">
                    ...
                    <div class="app-brand justify-content-center mt-5">
                        <a href="index.html" class="app-brand-link gap-2">
                            ...
                            <span class="app-brand-text demo text-heading fw-semibold">Chalchitra</span>
                        </a>
                    </div>
                    <!-- /Logo -->

                    <div class="card-body mt-2">
                        <h4 class="mb-2">Welcome to Chalchitra! 👋</h4>
                        <p class="mb-4">Admin Register</p>

                        <form id="formAuthentication" class="mb-3" action="{{url('/registerAdmin')}}" method="POST">
                            @csrf
                            ...
                            <div class="form-floating form-floating-outline mb-4">
                                <select class="form-select" name="userrole" id="exampleFormControlSelect1"
                                    aria-label="Default select example">
                                    <option selected="">Select User Role</option>
                                    <option value="1">User Role 1</option>
                                    <option value="2">User Role 2</option>
