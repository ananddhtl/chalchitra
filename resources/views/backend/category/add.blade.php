        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Movie /</span> Add Movie Category</h4>
                                    ...
                                    <div class="card-body demo-vertical-spacing demo-only-element">
                                        <div class="input-group input-group-merge">
                                            <input type="text" class="form-control" placeholder="Enter Category Title"
                                                aria-label="Enter Movie Title" name="title" aria-describedby="basic-addon33">
                                        </div>
